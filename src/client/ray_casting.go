...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	ebitenutil.DebugPrintAt(screen, fmt.Sprintf("FPS: %0.2f", ebiten.ActualFPS()), 150, 222)
...
func main() {
	...
	g.objects = append(g.objects, object{[]line{{150, 210, 200, 160}}})
	g.objects = append(g.objects, object{[]line{{150, 150, 200, 200}}})
	// Rectangles
